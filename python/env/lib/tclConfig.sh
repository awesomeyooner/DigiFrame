...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /home/dev/Documents/GitHub/DigiFrame/python/env/include -fdebug-prefix-map=/croot/tk_1748849386456/work=/usr/local/src/conda/tk-8.6.14 -fdebug-prefix-map=/home/dev/Documents/GitHub/DigiFrame/python/env=/usr/local/src/conda-prefix -pipe -m64 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /home/dev/Documents/GitHub/DigiFrame/python/env/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/home/dev/Documents/GitHub/DigiFrame/python/env/lib -Wl,-rpath-link,/home/dev/Documents/GitHub/DigiFrame/python/env/lib -L/home/dev/Documents/GitHub/DigiFrame/python/env/lib -Wl,--export-dynamic '
